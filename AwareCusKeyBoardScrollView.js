...
export default class AwareCusKeyBoardScrollView extends PureComponent {
  ...
  componentDidMount() {
    this.showCustomKeyBoardSub = CustomKeyboard.addKeyBoardShowListener(
      this._onFocus
    );
    this.hideCustomKeyboardSub = CustomKeyboard.addKeyBoardHideListener(
      this._onReset
    );
  ...
  componentWillUnmount() {
    this.showCustomKeyBoardSub &&
      CustomKeyboard.removeKeyBoardListener(this.showCustomKeyBoardSub);
    this.hideCustomKeyboardSub &&
      CustomKeyboard.removeKeyBoardListener(this.hideCustomKeyboardSub);
